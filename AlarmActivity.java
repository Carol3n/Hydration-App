...
public class AlarmActivity extends AppCompatActivity {
    ...
    TextView textViewWeight, textViewTime;
    Vibrator mVibrator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> timingList = databaseHelper.getTimings(weight);
        ...
        buttonDismiss.setOnClickListener(v -> {
            ...
            mVibrator.cancel();
            ringtone.stop();
            Log.i("daysLeft", String.valueOf(databaseHelper.noOfDaysLeft(weight, nextAlarmTime)));
            if (databaseHelper.noOfDaysLeft(weight, nextAlarmTime) > 0)
                setAlarm(nextAlarmTime, weight);
            finish();
        });
